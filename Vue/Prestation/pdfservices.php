 ...
 <div class="col-lg-6">
     ...
     <?php $date= date("d-m-Y", strtotime($this->nettoyer($prestation['Date']))); ?> 
        ...
        <tr >
          ...
          <td  colspan="5"><?= $this->nettoyer($client['Nom']) ?>/ <b><?= $this->nettoyer($service['chantier']) ?></b></td>
       ...
       <th colspan="15"> 
       <b>Description des prestations à réaliser pour cette intervention:<b><br><?=  $this->nettoyer($prestation['Description']) ?> </th>
