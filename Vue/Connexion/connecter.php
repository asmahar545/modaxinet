        ...
        <table id="example1"  class="table table-bordered table-striped">
            ...
            <?php foreach ($prestation as $prest): ?>
                ...
                <tr>
                    ...
                    <td><a href="prestation" class="btn btn-xs btn-success"><span class="glyphicon glyphicon-plus"></span> </a>
                    <a  href="prestation/trimestre" class="btn btn-xs btn-danger"><span class="glyphicon glyphicon-file"></span> </a>
